#ifndef DualVNH5019MotorShield2_h
#define DualVNH5019MotorShield2_h

#include <Arduino.h>

class DualVNH5019MotorShield2
{
  public:  
    // CONSTRUCTORS
    DualVNH5019MotorShield2(); // Default pin selection.
    DualVNH5019MotorShield2(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
