#include "DualVNH5019MotorShield2.h"

// Constructors ////////////////////////////////////////////////////////////////

DualVNH5019MotorShield2::DualVNH5019MotorShield2()
{
  //Pin map
  _INA1 = 49;
  _INB1 = 38;
...
DualVNH5019MotorShield2::DualVNH5019MotorShield2(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
...
// Public Methods //////////////////////////////////////////////////////////////
void DualVNH5019MotorShield2::init()
{
...
void DualVNH5019MotorShield2::setM1Speed(int speed)
{
...
void DualVNH5019MotorShield2::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void DualVNH5019MotorShield2::setSpeeds(int m1Speed, int m2Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
}
...
void DualVNH5019MotorShield2::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DualVNH5019MotorShield2::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DualVNH5019MotorShield2::setBrakes(int m1Brake, int m2Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
}
...
unsigned int DualVNH5019MotorShield2::getM1CurrentMilliamps()
{
...
unsigned int DualVNH5019MotorShield2::getM2CurrentMilliamps()
{
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char DualVNH5019MotorShield2::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char DualVNH5019MotorShield2::getM2Fault()
{
